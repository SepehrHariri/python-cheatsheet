...
def main():
    ...
    def get_images():
        url = 'https://sepehrhariri.github.io/python-cheatsheet/web/mario_bros.png'
...
continents = pd.read_csv('https://sepehrhariri.github.io/python-cheatsheet/web/continents.csv',
...
* **Searching `'#<title>'` on the [webpage](https://sepehrhariri.github.io/python-cheatsheet/) will limit the search to the titles.**
